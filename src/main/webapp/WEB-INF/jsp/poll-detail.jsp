    ...
    <script>
        (function() {
            ...
            if (referrer && !referrer.includes(currentPath)) {
                sessionStorage.setItem('poll_back_url', referrer);
            }
        })();
...
<div class="container py-5">
    <div class="ui-card bg-white p-5 shadow-sm">
        ...
        <a href="javascript:void(0)" onclick="handleSmartBack()" class="btn btn-link mb-3 p-0 text-decoration-none">❮ Back to Course</a>
